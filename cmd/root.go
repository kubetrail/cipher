...
var rootCmd = &cobra.Command{
	Use:   "cipher",
	Short: "CLI tool for encrypting files",
	Long: `An industrial grade tool to encrypt large files using
RSA keys that are themselves optionally encrypted using Google KMS`,
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".cipher" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigType("yaml")
		viper.SetConfigName(".cipher")
	}
